...
import 'package:e_payment/src/presentation/subscriptionstatus.dart';
...
class ReceiptDetailsScreen extends StatelessWidget {
  ...
  Future<String> getSubscriptionStatus() async {
    ...
    print('oooooooo Subscription Status:');
  ...
  Widget build(BuildContext context) {
    ...
    //     SubscriptionStatusProvider.getSubscriptionStatus();
    return FutureBuilder<String>(
        future: getSubscriptionStatus(),
        builder: (context, snapshot) {
            
            final userSubscriptionStatus = snapshot.data;
          
          // String userSubscriptionStatus = await getSubscriptionStatus();

          final RecognizeText recognizeText =
              Provider.of<RecognizeText>(context);
                          ...
                          : GestureDetector(
                              onTap: () async {
                                ...
                                if (recognizeText.receiptName != null &&
                                  ...
                                  await receiptFirestore
                                      .getReceiptDataFromFirestore(
                                          recognizeText.refNo);
                                    ...
                                    showDialog(
                                      ...
                                      builder: (context) {
                                        final SwitchReceiptPhoto
                                            ...
                                            Provider.of<SwitchReceiptPhoto>(
                                                context);
                                        final ReceiptFirestore
                                            receiptAlertFirestore =
                                            Provider.of<ReceiptFirestore>(
                                                context);
